      ...
      <nav class="navbar-default navbar-static-side" role="navigation">
        <div class="sidebar-collapse">
          <ul class="nav metismenu" id="side-menu" style="min-height: 100vh">
              ...
              <div class="dropdown profile-element">
                ...
                <a data-toggle="dropdown" href="#">
                            <span class="clear"> <span class="block m-t-xs"> <strong style="color: #fff;">创新石油</strong>
                             </span><br/> <span class="text-muted text-xs block"style="color: #fff;">CHUANGXIN PETROLEUM</span> </span> </a>
              </div>
            ...
            <li>
              <a href="index.html"><i class="fa fa-th-large"></i> <span class="nav-label">油井区块一</span> <span class="fa arrow"></span></a>
...
//  import  m from 'metismenu/dist/metisMenu.min.js'
    export default {
      data () {
        return {
